...
import {
  Container, Typography, List, ListItem, ListItemText, IconButton, TextField,
  Button, Paper, Box, Divider, Avatar, Stack, Grid
} from '@mui/material';
              ...
              {items.map((item, index) => (
                <Box key={item.productId}>
                  <ListItem sx={{ p: 3, alignItems: 'flex-start' }}>
                    ...
                    />
                    <Stack direction="column" sx={{ gap: 1, alignItems: 'flex-end' }}>
                      <TextField
                        label="Qty"
                        type="number"
                        size="small"
